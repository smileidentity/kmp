...
class SmileIdentity private constructor(private val config: SmileIdentityConfig) {
  ...
  companion object {
    ...
    /**
     * Returns the singleton instance of Smile Identity SDK. If not initialized, it creates a
     * default instance.
     */
    ...
    /**
     * Creates a default SDK instance with placeholder configuration. This should be overridden by
     * proper user-provided configurations.
     */
  ...
  class Builder {
    ...
    fun setProductionLambdaUrl(productionLambdaUrl: String) = apply {
      this.productionLambdaUrl = productionLambdaUrl
    }
