...
buildkonfig {
  ...
  defaultConfigs {
    buildConfigField(
      ...
      value = localProperties.getProperty("SMILE_ID_API_KEY") ?: System.getenv("SMILE_ID_API_KEY"),
    )
    ...
    buildConfigField(
      ...
      value =
        localProperties.getProperty("SMILE_ID_ENVIRONMENT") ?: System.getenv("SMILE_ID_ENVIRONMENT"),
    )
    ...
    buildConfigField(
      ...
      value =
        localProperties.getProperty("SMILE_ID_SMILE_LINK") ?: System.getenv("SMILE_ID_SMILE_LINK"),
    )
    ...
    buildConfigField(
      ...
      value =
        localProperties.getProperty("SMILE_ID_AUTH_TOKEN") ?: System.getenv("SMILE_ID_AUTH_TOKEN"),
    )
    buildConfigField(
      type = FieldSpec.Type.STRING,
      name = "SMILE_ID_PROD_LAMBDA_URL",
      value =
        localProperties.getProperty("SMILE_ID_PROD_LAMBDA_URL")
    ...
    buildConfigField(
      ...
      value =
        localProperties.getProperty("SMILE_ID_TEST_LAMBDA_URL")
    ...
    buildConfigField(
      ...
      value =
        localProperties.getProperty("SMILE_ID_PARTNER_ID") ?: System.getenv("SMILE_ID_PARTNER_ID"),
    )
  }
}
